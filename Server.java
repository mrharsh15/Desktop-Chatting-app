...
public class Server extends JFrame implements ActionListener {
    ...
    Server(){
        ...
        text.setFont(new Font("SAN_SERIF", 0, 16));
        add(text);
        ...
        send.setFont(new Font("SAN_SERIF", 0, 16));
    ...
    public static JPanel formatLabel(String msg){
        ...
        output.setFont(new Font("Tahoma", 1, 16));
